...
export const toys: Toy[] = [
  ...
  {
    id: 108,
    name: "1166 Heavy Duty Jeep",
    description: "Small heavy duty electric ride-on jeep designed for kids with powerful motor and durable construction.",
    price: 18999,
    category: "cars/rideables",
    age: "3-8 years",
    image: "/img/jeep/1166 SMALL Heavy Duty Electric Ride On Jeep For Kids.png",
    images: [
      "/img/jeep/1166 SMALL Heavy Duty Electric Ride On Jeep For Kids.png",
      "/img/jeep/1166 SMALL Heavy Duty Electric Ride On Jeep For Kids 02.png"
    ],
    features: ["Heavy Duty", "Small Size", "Electric Powered", "Durable Construction", "LED Lights", "Remote Control"],
    inStock: true,
    rating: 4.7,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 109,
    name: "20M 4x4 Big Size Jeep",
    description: "Large 4x4 battery operated jeep with 12V battery system for extended playtime and powerful performance.",
    price: 22999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/20M 44 SRECAP Battery Operated 4x4 Big Size Jeep 12V Battery.jpg",
    images: [
      "/img/jeep/20M 44 SRECAP Battery Operated 4x4 Big Size Jeep 12V Battery.jpg",
      "/img/jeep/20M 44 SRECAP Battery Operated 4x4 Big Size Jeep 12V Battery 02.jpg"
    ],
    features: ["4x4 Drive", "12V Battery", "Big Size", "Battery Operated", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.6,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 110,
    name: "2188 4x4 Big Wheels Jeep",
    description: "Premium 4x4 battery ride-on jeep with big size wheels for superior traction and off-road capability.",
    price: 24999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/2188 Battery Ride On Jeep 4x4 Big Size Wheels for Kids.jpg",
    images: [
      "/img/jeep/2188 Battery Ride On Jeep 4x4 Big Size Wheels for Kids.jpg",
      "/img/jeep/2188 Battery Ride On Jeep 4x4 Big Size Wheels for Kids 02.jpg"
    ],
    features: ["4x4 Drive", "Big Size Wheels", "Battery Operated", "Premium Build", "LED Lights", "Remote Control"],
    inStock: true,
    rating: 4.8,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 111,
    name: "21B Electric Jeep",
    description: "Electric battery operated ride-on jeep with advanced motor system and smooth handling for kids.",
    price: 19999,
    category: "cars/rideables",
    age: "3-10 years",
    image: "/img/jeep/21B Electric Battery Operated Ride on Jeep for Kids.jpg",
    images: [
      "/img/jeep/21B Electric Battery Operated Ride on Jeep for Kids.jpg",
      "/img/jeep/21B Electric Battery Operated Ride on Jeep for Kids 02.jpg"
    ],
    features: ["Electric Powered", "Battery Operated", "Advanced Motor", "Smooth Handling", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.5,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 112,
    name: "6188 Heavy Duty 4x4",
    description: "Heavy duty 4x4 electric ride-on jeep with 12V power system and robust construction for adventurous kids.",
    price: 27999,
    category: "cars/rideables",
    age: "5-14 years",
    image: "/img/jeep/4X4 Heavy Duty 12V Electric Ride On Jeep For Kids 6188.jpg",
    images: [
      "/img/jeep/4X4 Heavy Duty 12V Electric Ride On Jeep For Kids 6188.jpg",
      "/img/jeep/4X4 Heavy Duty 12V Electric Ride On Jeep For Kids 6188 02.jpg"
    ],
    features: ["4x4 Drive", "Heavy Duty", "12V Power", "Robust Construction", "LED Lights", "Remote Control"],
    inStock: true,
    rating: 4.7,
    reviews: 0,
    showPrice: false
  },
  {
    id: 113,
    name: "6166 4x4 Jeep",
    description: "Premium 4x4 ride-on jeep with advanced features and authentic jeep styling for young adventurers.",
    price: 23999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/6166 4  4 Ride On Jeep For Kids.png",
    images: [
      "/img/jeep/6166 4  4 Ride On Jeep For Kids.png",
      "/img/jeep/6166 4  4 Ride On Jeep For Kids 02.png"
    ],
    features: ["4x4 Drive", "Premium Build", "Authentic Styling", "LED Lights", "Music System", "Remote Control"],
    inStock: true,
    rating: 4.6,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 114,
    name: "6700 Four-Wheel Drive",
    description: "Advanced four-wheel drive electric car with superior traction and performance for kids.",
    price: 25999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/6700 Jeep Kid's Electric Car Four-Wheel Drive 44.png",
    images: [
      "/img/jeep/6700 Jeep Kid's Electric Car Four-Wheel Drive 44.png",
      "/img/jeep/6700 Jeep Kid's Electric Car Four-Wheel Drive 44 02.jpg"
    ],
    features: ["Four-Wheel Drive", "Electric Powered", "Superior Traction", "Advanced Features", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.7,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 115,
    name: "BMW Model Red Jeep",
    description: "Premium BMW model red electric jeep with authentic styling and advanced features for young drivers.",
    price: 29999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/Electric Battery Operated Kids Jeep BMW Model Red Manual Driving Kids Jeep – 9111-Red.jpg",
    images: [
      "/img/jeep/Electric Battery Operated Kids Jeep BMW Model Red Manual Driving Kids Jeep – 9111-Red.jpg",
      "/img/jeep/Electric Battery Operated Kids Jeep BMW Model Red Manual Driving Kids Jeep – 9111-Red 02.jpg"
    ],
    features: ["BMW Design", "Electric Powered", "Authentic Styling", "Premium Features", "LED Lights", "Remote Control"],
    inStock: true,
    rating: 4.8,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 116,
    name: "Construction Tractor",
    description: "Construction-themed electric tractor with front loader for kids aged 2 to 7 years, featuring 12V battery operation.",
    price: 17999,
    category: "cars/rideables",
    age: "2-7 years",
    image: "/img/jeep/Electric Tractor for Kids- Ride on Custruction Ride on with Front Loader-12v Battery Operated for Kids of Age 2 to 7 Years (Red).png",
    images: [
      "/img/jeep/Electric Tractor for Kids- Ride on Custruction Ride on with Front Loader-12v Battery Operated for Kids of Age 2 to 7 Years (Red).png",
      "/img/jeep/Electric Tractor for Kids- Ride on Custruction Ride on with Front Loader-12v Battery Operated for Kids of Age 2 to 7 Years (Red) 02.png"
    ],
    features: ["Construction Theme", "Front Loader", "12V Battery", "Electric Powered", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.6,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 117,
    name: "Red Ride-On Car",
    description: "Stylish red battery operated ride-on car with modern design and smooth performance for young drivers.",
    price: 15999,
    category: "cars/rideables",
    age: "3-10 years",
    image: "/img/jeep/Kids Battery Operated Ride on Car Red.png",
    images: [
      "/img/jeep/Kids Battery Operated Ride on Car Red.png",
      "/img/jeep/Kids Battery Operated Ride on Car Red 02.png"
    ],
    features: ["Battery Operated", "Modern Design", "Smooth Performance", "LED Lights", "Music System", "Remote Control"],
    inStock: true,
    rating: 4.5,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 118,
    name: "Mercedes Jumbo Jeep",
    description: "Jumbo size Mercedes-style kids jeep with premium features and authentic Mercedes branding.",
    price: 32999,
    category: "cars/rideables",
    age: "4-12 years",
    image: "/img/jeep/Mercedez Ride on Jumbo Size Kids Jeep.png",
    images: [
      "/img/jeep/Mercedez Ride on Jumbo Size Kids Jeep.png",
      "/img/jeep/Mercedez Ride on Jumbo Size Kids Jeep 02.png"
    ],
    features: ["Mercedes Design", "Jumbo Size", "Premium Features", "Authentic Branding", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.8,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 119,
    name: "MKS-002 Rechargeable",
    description: "Rechargeable battery operated ride-on toy in red color with advanced features and long battery life.",
    price: 19999,
    category: "cars/rideables",
    age: "3-10 years",
    image: "/img/jeep/MKS-002 Battery Operated Rechargeable Ride On Toy For Kids (Red).jpg",
    images: [
      "/img/jeep/MKS-002 Battery Operated Rechargeable Ride On Toy For Kids (Red).jpg",
      "/img/jeep/MKS-002 Battery Operated Rechargeable Ride On Toy For Kids (Red) 02.jpg"
    ],
    features: ["Rechargeable Battery", "Long Battery Life", "Advanced Features", "LED Lights", "Music System", "Remote Control"],
    inStock: true,
    rating: 4.6,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 120,
    name: "Rubiko Electric Car",
    description: "Premium rechargeable Rubiko electric car with modern design and advanced features for young drivers.",
    price: 21999,
    category: "cars/rideables",
    age: "3-10 years",
    image: "/img/jeep/Rechargeable Rubiko Electric Car for Kids.png",
    images: [
      "/img/jeep/Rechargeable Rubiko Electric Car for Kids.png",
      "/img/jeep/Rechargeable Rubiko Electric Car for Kids 02.png"
    ],
    features: ["Rechargeable", "Modern Design", "Advanced Features", "LED Lights", "Music System", "Smooth Ride"],
    inStock: true,
    rating: 4.7,
    reviews: 0,
    showPrice: false
  },
  {
    ...
    description: "Remote control electric ride-on tractor for children with construction theme and interactive features.",
    price: 18999,
    category: "cars/rideables",
    age: "2-8 years",
    image: "/img/jeep/Remote Control Electric Ride On Tractor for Child.jpg",
    images: [
      "/img/jeep/Remote Control Electric Ride On Tractor for Child.jpg",
      "/img/jeep/Remote Control Electric Ride On Tractor for Child 02.jpg"
    ],
    features: ["Remote Control", "Electric Powered", "Construction Theme", "Interactive Features", "LED Lights", "Music System"],
    inStock: true,
    rating: 4.5,
    reviews: 0,
    showPrice: false
  ...
  {
    id: 122,
    name: "YN-908 Toddler Jeep",
    description: "Compact red ride-on jeep designed specifically for children aged 1 to 4 years with safety features.",
    price: 14999,
    category: "cars/rideables",
    age: "1-4 years",
    image: "/img/jeep/YN-908 Ride On Jeep For 1 to 4 Year Red.png",
    images: [
      "/img/jeep/YN-908 Ride On Jeep For 1 to 4 Year Red.png",
      "/img/jeep/YN-908 Ride On Jeep For 1 to 4 Year Red 02.png"
    ],
    features: ["Compact Size", "Safety Features", "Designed for Toddlers", "LED Lights", "Music System", "Parent Control"],
    inStock: true,
    rating: 4.6,
    reviews: 0,
    showPrice: false
